...
const Toggle = ({ toggleTheme }) => {
  ...
  useEffect(() => {
    ...
    if (theme === "dark") {
      ...
      ball.setAttribute(
        "style",
        "transform:translatex(100%);border-color:white"
      );
    }
    if (theme === "light") {
      box.setAttribute("style", "background-color:black;");
      ball.setAttribute("style", "transform:translatex(0%);border-color:black");
    }
  }, [theme]);
  return (
    <div className="toggle">
      <div className="btn p-0 m-0">
        <input type="checkbox" name="check" id="check" onClick={toggleTheme} />
